            ...
            <div class="col-12">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                                ...
                                <?php
                                    if($get_all_user == false) {
                                        ...
                                        foreach($get_all_user as $key => $row) {
                                            ...
                                            echo "<td width='20%'> <img width='40%' src=uploads/$user_image></td>";
                                            echo "<td>$new_date_created</td>";
                                            echo "<td><a href='editUser.php?user_id=$user_id' class='btn btn-info'>Edit</a></td>";
                                            echo "<td><a href='deleteUser.php?user_id=$user_id' class='btn btn-danger'>Delete</a></td>";
                                            echo "<td><a href='addUserPhoto.php?user_id=$user_id' class='btn btn-primary' >Add photo</a>
                        </td>";
                                            echo "</tr>";
                                        }
                                    }
                        ...
                        <a href="logout.php" class="btn btn-secondary float-right">Log out</a> 
                    </div>                    
                </div>
            </div>
        </div>
